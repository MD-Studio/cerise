...
project = u'simple-cwl-xenon-service'
...
#html_title = u'simple-cwl-xenon-service v0.0.1'
...
latex_documents = [
    (master_doc, 'simple-cwl-xenon-service.tex', u'empty\\_python Documentation',
...
man_pages = [
    (master_doc, 'simple-cwl-xenon-service', u'simple-cwl-xenon-service Documentation',
     [author], 1)
]
