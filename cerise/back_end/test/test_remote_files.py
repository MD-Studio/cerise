...
def fixture(request, tmpdir):
    from cerise.back_end.remote_files import RemoteFiles
...
def test_stage_job(fixture):
    ...
    fixture['remote-files'].stage_job('test_stage_job', input_files)
...
def test_stage_secondary_files(fixture):
    ...
    fixture['remote-files'].stage_job('test_stage_secondary_files', input_files)
...
def test_stage_file_array(fixture):
    ...
    fixture['remote-files'].stage_job('test_stage_file_array', input_files)
...
def test_destage_job_no_output(fixture):
    ...
    output_files = fixture['remote-files'].destage_job_output('test_destage_job_no_output')
    assert output_files == []

def test_destage_job_output(fixture):
    fixture['store'].add_test_job('test_destage_job_output', 'wc', 'run_and_updated')
    output_files = fixture['remote-files'].destage_job_output('test_destage_job_output')
